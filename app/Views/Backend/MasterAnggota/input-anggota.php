                    ...
                    <form class="form-horizontal" action="<?= base_url('admin/simpan-anggota'); ?>" method="post">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="nama" name="nama" type="text" placeholder="Masukkan Nama Anggota" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="no_tlp" name="no_tlp" type="text" placeholder="Masukkan Nomor Telepon" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="password" name="password" type="password" placeholder="Masukkan Password Awal" class="form-control" required>
                                    <span class="help-block">Password awal untuk anggota login.</span>
                                </div>
                            </div>
